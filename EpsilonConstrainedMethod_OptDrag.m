...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% script "EpsilonConstrainedMethod_OptDrag"
...
%       This one is for optimizing drag while constraining volume.
%
%% Instructions:
%       Just hit "Run". A plot of the objective functions vs epsilon is generated. 
%       And the results are saved in 'EC_results.mat'. 
...
% saveas(gcf,'EC_NormalizedCriterionSpace.jpg')
...
% saveas(gcf,'EC_NormalizedCriterionSpace_WeightedTrend.jpg')

%% save results
save('EC_results.mat', 'X', 'f1', 'f2', 'f1_s', 'f2_s', 'e', 'Lq1', 'Lq2', 'Lqinf')

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% objective function - single objective f1
function f1_s = myfun(X)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% nonlinear constraint function - constraining f2
...
% lower limit interal volume constraint
g11 = eval_g11(d, L, f2_g, f2_b, epsilon);
