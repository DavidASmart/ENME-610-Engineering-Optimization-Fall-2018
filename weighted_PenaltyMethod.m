...
axis([0,1,0,1])
% saveas(gcf,'penalty_NormalizedCriterionSpace.jpg')
...
axis([0,1,0,1])
% saveas(gcf,'penalty_NormalizedCriterionSpace_WeightedTrend.jpg')

%% save results
save('penalty_results.mat', 'X', 'f1', 'f2', 'f1_s', 'f2_s', 'W1', 'W2', 'Lq1', 'Lq2', 'Lqinf')
